...
function applyTranslations(lang) {
    ...
    elementsToTranslate.forEach((el)=>{
        ...
        const translationValue = (0, _translationsJsonDefault.default)[lang]?.[key];
        if (typeof translationValue !== 'undefined') {
            ...
            if (translationValue.includes('<') && translationValue.includes('>')) el.innerHTML = translationValue;
            else el.textContent = translationValue;
        }
    });
    if (pageTitleElement) {
...
function setupHeroCarousel() {
    ...
    if (!carouselContainer || !(0, _mediaContentJsDefault.default)?.gallery?.photos) return; // Exit if container or photos are not available
    const photos = (0, _mediaContentJsDefault.default).gallery.photos;
...
var _sponsorSeiPng = require("url:./img/sponsor-sei.png");
var _sponsorSeiPngDefault = parcelHelpers.interopDefault(_sponsorSeiPng);
var _sponsorSmartfrenSvg = require("url:./img/sponsor-smartfren.svg");
var _sponsorSmartfrenSvgDefault = parcelHelpers.interopDefault(_sponsorSmartfrenSvg);
const mediaContent = {
    "blogArticles": [
        {
            "id": "artikel-1",
    ...
    "partnersSponsors": [
        ...
        },
        {
            "id": "partner-4",
            "name": "SEI Indonesia",
            "logoUrl": (0, _sponsorSeiPngDefault.default),
            "type": "sponsor",
        ...
        },
        {
            "id": "partner-5",
            "name": "Smartfren",
            "logoUrl": (0, _sponsorSmartfrenSvgDefault.default),
            "type": "sponsor",
...
},{"url:./img/IMG_3203.jpg":"dIi1b","url:./img/IMG_3281.jpg":"f2Sbt","url:./img/IMG_3227.jpg":"biUb5","url:./img/S0952298.jpg":"a98jg","url:./img/IMG_3058.jpg":"7axgJ","url:./img/IMG_3376.jpg":"hCWkQ","url:./img/IMG_3104.jpg":"cvOue","url:./img/rickroll.jpg":"luomu","url:./img/medpart-microit.png":"fAwOn","url:./img/medpart-likista.png":"1iYPz","url:./img/medpart-infosvipb.png":"bOTbj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:./img/sponsor-sei.png":"2O06q","url:./img/sponsor-smartfren.svg":"64TO5"}],"dIi1b":[function(require,module,exports,__globalThis) {
...
},{}],"2O06q":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("sponsor-sei.071752ee.png") + "?" + Date.now();

},{}],"64TO5":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("sponsor-smartfren.086564c7.svg") + "?" + Date.now();
